...
var walkAST = (node, { enter, leave, enterAfter, leaveAfter }) => {
  ...
  walk(ast, {
    enter(node2, parent, ...args) {
      ...
      enter == null ? void 0 : enter.call({ ...scopeCtx(), ...walkerCtx }, node2);
      node2 = getNode();
      if (!isSkip() && !isRemoved()) {
        enterNode(node2, parent);
        enterAfter == null ? void 0 : enterAfter.call(scopeCtx(), node2);
      }
    },
    leave(node2, parent, ...args) {
      const { scopeCtx, walkerCtx, isSkip, isRemoved, getNode } = getHookContext(this, node2, [parent, ...args]);
      leave == null ? void 0 : leave.call({ ...scopeCtx(), ...walkerCtx }, node2);
      node2 = getNode();
      if (!isSkip() && !isRemoved()) {
        leaveNode(node2, parent);
        leaveAfter == null ? void 0 : leaveAfter.call(scopeCtx(), node2);
      }
    }
  });
