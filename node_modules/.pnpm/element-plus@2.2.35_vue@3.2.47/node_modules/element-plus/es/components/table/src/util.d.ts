...
export declare function createTablePopper(parentNode: HTMLElement | undefined, trigger: HTMLElement, popperContent: string, tooltipOptions?: TableOverflowTooltipOptions): Nullable<{
