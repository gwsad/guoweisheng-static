...
declare function importHelperFn(s: MagicString, offset: number, name: string, from: string): void;

export { HELPER_PREFIX, SFC, _SFCScriptBlock, addNormalScript, getFileCodeAndLang, importHelperFn, parseSFC };
