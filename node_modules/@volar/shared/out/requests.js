...
(function (GetAutoQuoteEditsRequest) {
    GetAutoQuoteEditsRequest.type = new rpc.RequestType('html/autoCreateQuote');
})(GetAutoQuoteEditsRequest = exports.GetAutoQuoteEditsRequest || (exports.GetAutoQuoteEditsRequest = {}));
var GetTagCloseEditsRequest;
(function (GetTagCloseEditsRequest) {
    GetTagCloseEditsRequest.type = new rpc.RequestType('html/autoCloseTag');
...
(function (GetWrapParenthesesEditsRequest) {
    GetWrapParenthesesEditsRequest.type = new rpc.RequestType('html/autoWrapParentheses');
})(GetWrapParenthesesEditsRequest = exports.GetWrapParenthesesEditsRequest || (exports.GetWrapParenthesesEditsRequest = {}));
var GetRefCompleteEditsRequest;
(function (GetRefCompleteEditsRequest) {
    GetRefCompleteEditsRequest.type = new rpc.RequestType('volar/autoCompleteRef');
