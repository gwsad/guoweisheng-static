...
function register({ modules: { typescript: ts }, sourceFiles, getTsLs, vueHost, scriptTsLs }) {
    return async (item, newPosition) => {
            ...
            if (data.tsItem.additionalTextEdits) {
                for (const edit of data.tsItem.additionalTextEdits) {
                    if (edit.range.start.line === 0
                        ...
                        edit.newText = ((_b = (_a = vueHost.getNewLine) === null || _a === void 0 ? void 0 : _a.call(vueHost)) !== null && _b !== void 0 ? _b : '\n') + edit.newText;
                    }
                }
            }
        ...
        async function getAutoImportResult(sourceFile, vueItem, data) {
            ...
            async function planAInsertText() {
                ...
                const [formatOptions, preferences] = await Promise.all([
                    (_b = (_a = vueHost.getFormatOptions) === null || _a === void 0 ? void 0 : _a.call(vueHost, scriptDoc)) !== null && _b !== void 0 ? _b : {},
                    (_d = (_c = vueHost.getPreferences) === null || _c === void 0 ? void 0 : _c.call(vueHost, scriptDoc)) !== null && _d !== void 0 ? _d : {},
                ]);
