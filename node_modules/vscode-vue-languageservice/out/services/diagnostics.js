...
function register({ sourceFiles, getCssLs, jsonLs, templateTsLs, scriptTsLs, vueHost, getTextDocument }, updateTemplateScripts) {
    ...
    function useDiagnostics(sourceFile) {
        const { cssLsDocuments, cssLsSourceMaps, sfcJsons, sfcScriptForScriptLs, lastUpdated, sfcTemplate, descriptor, document, sfcTemplateScript, sfcTemplateData, sfcTemplateCompileResult, templateScriptData, sfcScriptForTemplateLs, templateLsSourceMaps, scriptSetupRanges } = sourceFile.refs;
